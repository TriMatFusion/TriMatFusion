...
**Important Note:** The `matscibert` folder, containing the large `pytorch_model.bin` (approx. 419MB), is not included in this repository due to GitHub's file size limits. Please ensure you have correctly set up the MatSciBERT model locally before proceeding.
